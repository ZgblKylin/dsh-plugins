...
记录当前使用的第三方插件（无法通过插件市场安装），安装包名或源码路径如下：
...
- [dsh-deep-whale/maid-atelier](https://github.com/Small-tailqwq/dsh-deep-whale) 源码构建安装
- [dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite) 源码构建安装
